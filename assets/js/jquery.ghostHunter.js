		...
		/*	Here we load all of the blog posts to the index. 
			...
			$.get(ghost.url.api('posts',obj)).done(function(data){
				...
				searchData.forEach(function(arrayItem){
					...
					blogData[arrayItem.id] = {title: arrayItem.title, description: arrayItem.meta_description, pubDate: tempdate, link: arrayItem.url, id: arrayItem.id, markdown: arrayItem.markdown, authorId : arrayItem.author};
				});
			});
			this.isInit = true;
		},
